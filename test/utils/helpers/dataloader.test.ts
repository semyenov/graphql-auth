    ...
    describe('userById loader', () => {
        it('should batch load users by ID', async () => {
            ...
            const users = await Promise.all([
                prisma.user.create({ data: { email: 'user1@test.com', name: 'User 1', password: hashedPassword } }),
                prisma.user.create({ data: { email: 'user2@test.com', name: 'User 2', password: hashedPassword } }),
                prisma.user.create({ data: { email: 'user3@test.com', name: 'User 3', password: hashedPassword } }),
            ])
        ...
        it('should cache repeated requests', async () => {
            const user = await prisma.user.create({
                data: { email: 'cached@test.com', name: 'Cached User', password: hashedPassword }
            })
