 ...
 */
export async function getUserIdFromAuthHeaderAsync(authHeader: string | undefined): Promise<UserId | null> {
...
export function hasPermission(userId?: UserId, permission?: string): boolean {
    ...
    const basicPermissions = ['read:posts', 'create:posts', 'update:own_posts', 'delete:own_posts']
